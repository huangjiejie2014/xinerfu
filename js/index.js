$(function () {
    ...
    /*$(".container_list_box ul").hover(function () {
        $(this).find(".bt_join a").addClass("live");
    });*/

    $(".container_list_box ul").mouseenter(function(){
        $(".bt_join a").removeClass("live");
        $(this).find(".bt_join a").eq(0).addClass("live");
    });
    $(".container_list_box ul").mouseleave(function(){
        $(".topmenu .nav_item>a").removeClass("navActive");
    })
...
var banner = function () {
    ...
    $('.xef_banner').on('touchstart',function (e) {
...
var initMobileTab = function () {
    /*1.解决换行问题*/
    var $navTabs = $('.xef_product .nav-tabs');
    var width = 0;
